...
def K3_load_check(FileNo):

    filename = "K3_log_" + str(FileNo) + ".csv"
...
def test_k3():
    ...
    try:
        ...
        hK3 = m_bcapclient.controller_getextension(hCtrl, "K3Hand")
        print("Add K3 object")
        for ii in range(1, 10, 1):
            for IParamIndex in range(0, 9, 1):
                vntret = m_bcapclient.extension_execute(
                    hK3, "SetParam", IParamIndex)
                print(vntret)
            # End For
        # End For
